 ...
 * @Title: FineDeposit.java 
 * @Prject: trade-engine
 * @Package: com.hotent.trade.model 
 * @Description: TODO
 * @author: huke   
 * @date: 2019年8月12日 上午9:58:24 
 * @version: V1.0   
 */
package com.ydw.subsystem.model;

/**
 * @ClassName: FineDeposit
 * @Description: 罚没保证金
 * @author: huke
 * @date: 2019年8月12日 上午9:58:24
 */
public class FineDepositDO {
    ...
    public Double getPenAmount() {
        return penAmount;
    }

    public void setPenAmount(Double penAmount) {
